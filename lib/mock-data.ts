...
export const mockTickets: TicketRow[] = [
  {
    ...
    owner: { user_id: "Priya Sharma (Ops Lead)", queue_id: "HOSPITAL_QUEUE" },
    next_action: {
  ...
  },
  {
    ...
    owner: { user_id: "Rahul Verma (Ops Lead)", queue_id: "DOCS_PENDING" },
    next_action: {
  ...
  },
  {
    ...
    owner: { user_id: "TPA Ops Team", queue_id: "TPA_QUEUE" },
    next_action: {
      action_type: "ESCALATE",
      label: "Escalate",
      requires_role: "TPA_OPS"
...
export const mockTimeline: Record<string, TimelineEvent[]> = {
  "TKT-10481": [
    ...
    { event_id: "ev3", event_type: "INBOUND_WA", ts: "2026-03-14T08:30:00.000Z", actor: "Hospital User", payload_summary: { message_type: "text", length: 118 } },
    { event_id: "ev4", event_type: "OUTBOUND_TEMPLATE", ts: "2026-03-14T09:00:00.000Z", actor: "Priya Sharma (Ops Lead)", payload_summary: { status: "queued" }, template_id: "status_update_v3", template_version: 3, outbound_intent_id: "intent-481" },
  ...
  "TKT-10482": [
    ...
    { event_id: "ev8", event_type: "INBOUND_WA", ts: "2026-03-13T16:10:00.000Z", actor: "Hospital User", payload_summary: { message_type: "document", length: 1 } },
    { event_id: "ev9", event_type: "DOC_UPLOAD_LINK_CREATED", ts: "2026-03-14T06:00:00.000Z", actor: "Priya Sharma (Ops Lead)", payload_summary: { expiry: "2026-03-16T06:00:00.000Z" } }
  ],
  "TKT-10483": [
    { event_id: "ev10", event_type: "CASE_LINKED", ts: "2026-03-14T06:45:00.000Z", actor: "system", payload_summary: { reason: "Missing claim id" } },
    { event_id: "ev11", event_type: "INBOUND_WA", ts: "2026-03-14T07:15:00.000Z", actor: "Hospital User", payload_summary: { message_type: "image", length: 2 } },
    { event_id: "ev12", event_type: "DOC_UPLOAD_LINK_CREATED", ts: "2026-03-14T07:20:00.000Z", actor: "Rahul Verma (Ops Lead)", payload_summary: { expiry: "2026-03-15T07:20:00.000Z" } },
    { event_id: "ev13", event_type: "OUTBOUND_TEMPLATE", ts: "2026-03-14T07:21:00.000Z", actor: "Rahul Verma (Ops Lead)", payload_summary: { status: "sent" }, template_id: "missing_claim_id_v1", template_version: 1, outbound_intent_id: "intent-483" }
  ],
  "TKT-10484": [
    ...
    { event_id: "ev17", event_type: "INBOUND_WA", ts: "2026-03-13T04:30:00.000Z", actor: "Hospital User", payload_summary: { message_type: "text", length: 88 } }
  ],
  "TKT-10485": [
    ...
    { event_id: "ev20", event_type: "OUTBOUND_TEMPLATE", ts: "2026-03-14T02:10:00.000Z", actor: "TPA Ops Team", payload_summary: { status: "queued" }, template_id: "mismatch_escalation_v2", template_version: 2, outbound_intent_id: "intent-485" },
  ...
  "TKT-10486": [
    ...
    { event_id: "ev24", event_type: "INBOUND_WA", ts: "2026-03-10T09:18:00.000Z", actor: "Hospital User", payload_summary: { message_type: "text", length: 52 } },
    { event_id: "ev25", event_type: "OUTBOUND_TEMPLATE", ts: "2026-03-14T02:20:00.000Z", actor: "Admin User", payload_summary: { status: "blocked" }, template_id: "policy_hold_v1", template_version: 1, outbound_intent_id: "intent-486" }
  ]
};
